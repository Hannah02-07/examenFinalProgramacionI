...
public class Main {
    public static void main(String[] args) {
        ...
        if (opcion == 1) {
         ...
         class Agent{
            int agentLevel;
            public Agent(int agentLevel){
                this.agentLevel=agentLevel;
            }
            public void incrementarNivel(int incremento){
                this.agentLevel+=incremento;
                System.out.println("Nivel actual del agente: "+this.agentLevel);
            } 


        }
        int agentLevel =1;
        Agent agent1=new Agent(agentLevel);
        System.out.println("Nivel inicial del agente: " + agentLevel);

        agent1.incrementarNivel(1);
    }
}
